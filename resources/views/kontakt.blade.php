...
<header>
    <nav class="navbar navbar-default navbar-fixed-top" role="navigation">
		...
		<section class="call-to-action">
			<div class="container">
				<h3 class="cta-subheading text-center">Musu KONTAKTI </h3>
				<h2 class="text-center mt30">Ja ir kadas jautajumi tad rakstiet mums vai zvaniet! </h2>
				<div class="col-lg-12 text-center mt40">
                    ...
                    <style>
                        ...
                        h2 {
                            font: normal 1.6rem Arial, sans-serif; /* Параметры шрифта */
                        }
                        button {
                            padding: 0.7em 1.5em; /* Поля вокруг текста */
                        }
                    </style>
                    </head>
                    <body>
                    <h2>Rakstat mums uz musu e-pastu kolobtook@gmail.com</h2>

                    <h2>Zvaniet mums jebkura laika uz +37120004253</h2>
				</div>
			</div>
		</section>
			...
			<div class="container">
				<div class="row">
					<div class="col-sm-3 text-center">
						<div class="statistic">
							<span class="timer" data-from="0" data-to="623"></span>
					...
					<div class="col-sm-3 text-center">
						<div class="statistic">
							<span class="timer" data-from="0" data-to="760"></span>
					...
					<div class="col-sm-3 text-center">
						<div class="statistic">
							<span class="timer" data-from="0" data-to="3619"></span>
